...
export default function AIGallery() {
  ...
  {
    title: "Images",
    description: "Generate images with custom styles in Text and Instagram.",
    badge: "NEW",
    bg: "linear-gradient(0deg, #D0E3F1 0%, #294962 100%)",
    icon: (
       <svg
                      width="24"
                      height="24"
  ...
  {
    title: "Video",
    description: "Generate videos with Haiper, Pika, Runway and others.",
  ...
  {
    title: "Realtime",
    description: "Collaborate in realtime with AI models.",
    bg: "linear-gradient(0deg, #FFD6D6 0%, #FF5E5E 100%)",
    icon: (
      <svg
                      width="24"
                      height="24"
  ...
  {
    title: "Enhancer",
    description: "Enhance and upscale your images instantly.",
    bg: "linear-gradient(0deg, #E6FFFA 0%, #00C6A7 100%)",
    icon: (
       <svg
                      width="24"
                      height="24"
  ...
  {
    title: "Edit",
    description: "Edit your creations with AI-powered precision.",
    bg: "linear-gradient(0deg, #FFF4D6 0%, #FFB800 100%)",
    icon: (
      <svg
                      width="24"
                      height="24"
  ...
  {
    title: "Video Upscale",
    description: "Upscale videos to higher resolution effortlessly.",
    bg: "linear-gradient(0deg, #D6F0FF 0%, #007BFF 100%)",
    icon: (
       <svg
                      width="22"
                      height="22"
  ...
  },
  {
    ...
    description: "Apply motion from one video to another seamlessly.",
    bg: "linear-gradient(0deg, #F0D6FF 0%, #8A2BE2 100%)",
    icon: (
       <svg
                      width="42"
                      height="42"
                      class="absolute inset-0 z-10 m-auto shrink-0 text-white"
                      viewBox="0 0 48 48"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                    >
  ...
  // {
  //   title: "Train",
  //   description: "Train models on your own data to personalize results.",
  //   bg: "linear-gradient(0deg, #D6FFD6 0%, #28A745 100%)",
  //   icon: (
  //     <svg width="24" height="24" className="absolute inset-0 m-auto text-white">
  //       {/* SVG PATHS HERE */}
  //     </svg>
  //   ),
  // },
                  ...
                  <div className="grid gap-1">
                    ...
                    <span className="flex items-center justify-between">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="rounded-full text-primary py-2 px-3 bg-gray-100"
                      >
                        Open
                      </Button>
                    </span>
