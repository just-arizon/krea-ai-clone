                    ...
                    <span className="flex gap-1 items-center justify-between">
                      <h4 className="font-medium text-[14px]">Images</h4>
                       <Button
                        variant="ghost"
                        size="sm"
                        className="bg-[#f1f1f1] dark:bg-[#262626] ml-auto flex h-9 w-22 items-center justify-center rounded-full align-middle text-xs font-medium text-black dark:text-[#f1f1f1]"
                      >
                        Open
                      </Button>
                    </span>
          ...
          >
            <ul className="flex list-none p-0 m-0">
              <li>
                <a
                  href=""
                  className=" group relative my-1.5  block h-10 w-13 leading-none transition-colors duration-100 ease-out text-black dark:text-[#f1f1f1] mr-1.5"
                >
                  <svg
                    width="18"
                    height="18"
        ...
        <div className="flex-1 flex justify-end gap-3">
          <div className="flex items-center gap-3">
            <Button
              variant="outline"
              size="sm"
              className="gap-2 bg-[#f1f1f1] dark:bg-neutral-900 dark:hover:bg-neutral-800 cursor-pointer border-none outline-none"
            >
               <Images className="w-5 h-5 text-[#262626] dark:text-[#f1f1f1]  cursor-pointer" />
              <span>Gallery</span>
            </Button>
            <Button
              variant="outline"
              ...
              className="gap-2 bg-[#f1f1f1]  dark:bg-neutral-900 dark:hover:bg-neutral-800 cursor-pointer border-none outline-none"
            >
              <Headset className="w-5 h-5 text-[#262626] dark:text-[#f1f1f1] cursor-pointer" />
              <span>Support</span>
            </Button>
            ...
            {mounted && (
              <Button
                ...
                className="hover:bg-[#f1f1f1] dark:bg-neutral-900 bg-[#f1f1f1] dark:hover:bg-neutral-800 flex h-[30px] w-[30px] items-center justify-center rounded-lg text-black/70 backdrop-blur-lg transition-colors duration-150 ease-[cubic-bezier(.33,0,.2,1)] hover:text-black dark:text-[#f1f1f1] dark:hover:text-[#f1f1f1] cursor-pointer"
              >
                {theme === "dark" ? (
